...
import LinkList from '@/ui-kit/LinkList/LinkList.vue';
import Link from '@/ui-kit/Link/Link.vue';
import { SERVICES_FURNITURE, SERVICES_ROOMS } from '@/constants/services';
</script>
